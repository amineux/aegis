/**
 * Aegis Intelligence Layer — aegis-intel
 *
...
const WIKIDATA_UA = 'Aegis-Intel/1.0 (https://github.com/amineux/aegis; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'Aegis Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] Aegis Intelligence Layer starting...');
  await loadSanctions();
