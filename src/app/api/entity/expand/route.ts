...
/**
 * Thin proxy to the Aegis Intelligence Layer (aegis-intel).
 *
 * In Docker: fetches from http://aegis-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[AEGIS] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
