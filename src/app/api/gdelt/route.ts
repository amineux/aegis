...
/**
 * Aegis — Real-Time Geopolitical Events (GDELT 2.0 GeoJSON API)
...
export async function GET() {
  try {
    ...
    for (const rawItem of rawItems) {
      ...
      // Map GDACS event types to Aegis types. WF and DR used to fall through
    ...
    console.error('[AEGIS] GDACS fetch error:', error);
